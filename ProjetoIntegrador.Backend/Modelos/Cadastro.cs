...
public class Cadastro
{
    ...
    public string Senha { get; private ; }
    public string Username { get; private ; }
    ...
    private void InserirSenha(string senha)
    {
        ...
        if (senha.Length < 6)
            throw new Exception("A senha precisa ter no mínomo 6 caracteres!");
    ...
    private void InserirUsername(string username)
    {
        ...
        {
            throw new Exception("Não pode ter espaço no username!");
        }
